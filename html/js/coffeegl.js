...
},{"./math":4,"./shader":9,"./camera":13,"./signal":16,"./colour":5,"./error":19,"./debug":22}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
- TODO
  * Face normals and anything per face we need to deal with :S
  * Face things need to be moved down to their vertex representation i think
...
(function() {
  var Matrix4, Vec2, Vec3, Vec4, precomputeTangent, rayPlaneIntersect, _precomputeTangent, _ref;
  ...
  */
  ...
  Interpolation = (function() {
    ...
    Interpolation.prototype._setVec2 = function() {
      return new Vec2(obj0.x + ((obj1.x - obj0.x) * this.value), obj0.y + ((obj1.y - obj0.y) * this.value));
    };

    Interpolation.prototype._setVec3 = function() {
      return new Vec2(obj0.x + ((obj1.x - obj0.x) * this.value), obj0.y + ((obj1.y - obj0.y) * this.value), obj0.z + ((obj1.z - obj0.z) * this.value));
    };

    Interpolation.prototype._setVec4 = function() {
      return new Vec2(obj0.x + ((obj1.x - obj0.x) * this.value), obj0.y + ((obj1.y - obj0.y) * this.value), obj0.z + ((obj1.z - obj0.z) * this.value), obj0.w + ((obj1.w - obj0.w) * this.value));
    };

    Interpolation.prototype._setRGB = function() {
      return new Vec2(obj0.r + ((obj1.r - obj0.r) * this.value), obj0.g + ((obj1.g - obj0.g) * this.value), obj0.b + ((obj1.b - obj0.b) * this.value));
    };

    Interpolation.prototype._setRGBA = function() {
      return new Vec2(obj0.r + ((obj1.r - obj0.r) * this.value), obj0.g + ((obj1.g - obj0.g) * this.value), obj0.b + ((obj1.b - obj0.b) * this.value), obj0.a + ((obj1.a - obj0.a) * this.value));
    };
