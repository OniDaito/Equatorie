...
},{"./math":4,"./shader":9,"./camera":13,"./signal":16,"./error":19,"./colour":5,"./debug":20}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var CoffeeGLWarning, EPSILON_VALUE, Matrix3, Matrix4, PI, Quaternion, Vec2, Vec3, Vec4, degToRad, glMatrixArrayType, radToDeg, rayPlaneIntersect;
    ...
    JSONModel.prototype._parse = function(json_data) {
      ...
      for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
        ...
        if (child.geometry != null) {
          if (child.geometry.v.length === 0 || child.geometry.t.length === 0) {
            removals.push(child);
          }
        }
      }
...
(function() {
  ...
  brew = function(geometry) {
    var colours, gl, normals, size, uvs, v, vertices, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref5, _ref6, _ref7, _ref8;
...
(function() {
  ...
  ShaderLibrary = (function() {
    ...
    ShaderLibrary.BasicVertexColours = {
      vertex: "attribute vec4 aVertexColour; varying vec4 vColor;",
