...
},{"./util":2,"./app":3,"./math":4,"./colour":5,"./primitives":6,"./node":7,"./model":8,"./shader":9,"./request":10,"./fbo":11,"./texture":12,"./camera":13,"./shapes":14,"./webgl":15,"./signal":16,"./light":17,"./material":18,"./error":19,"./functions":20,"./animation":21}],2:[function(require,module,exports){
...
(function() {
  var CoffeeGLWarning, EPSILON_VALUE, Matrix3, Matrix4, PI, Quaternion, Vec2, Vec3, Vec4, degToRad, glMatrixArrayType, precomputeTangent, radToDeg, rayPlaneIntersect, _precomputeTangent;
...
},{"./colour":5,"./math":4}],3:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var App, CoffeeGLError, CoffeeGLLog, Colour, Matrix4, OrthoCamera, PerspCamera, Shader, Vec2, Vec3, Vec4, makeDebugContext, makeMouseEmitter, _ref, _ref1, _ref2,
    _this = this;
  ...
  _ref2 = require("./error"), CoffeeGLError = _ref2.CoffeeGLError, CoffeeGLLog = _ref2.CoffeeGLLog;
...
},{"./math":4,"./shader":9,"./camera":13,"./signal":16,"./colour":5,"./error":19,"./debug":22}],7:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./math":4,"./webgl":15,"./camera":13,"./material":18,"./texture":12,"./Light":23,"./primitives":6,"./util":2}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var CoffeeGLWarning, JSONModel, Material, Matrix4, Node, Quad, RGB, RGBA, Request, Texture, Triangle, TriangleMesh, Vec2, Vec3, Vec4, Vertex, _ref, _ref1, _ref2,
    _this = this,
    __hasProp = {}.hasOwnProperty,
    __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
  ...
  */
  ...
  JSONModel = (function(_super) {
    ...
    function JSONModel(json_data, params) {
      var closure, colourAmbient, colourDiffuse, colourSpecular, i, materials, n, specularCoef, t, url, _i, _ref3,
        _this = this;
      this.params = params;
      ...
      if (materials.length === 0) {
        ...
        for (i = _i = 0, _ref3 = materials.length - 1; 0 <= _ref3 ? _i <= _ref3 : _i >= _ref3; i = 0 <= _ref3 ? ++_i : --_i) {
          n = new Node();
          this.add(n);
    ...
    JSONModel.prototype._parse = function(json_data) {
      var child, cidx, i, i0, i1, i2, i3, midx, nidx, node_idx, prim, removals, type, type2, uvidx, vertices, vi0, vi1, vi2, vi3, vidx, _i, _j, _len, _len1, _ref3;
      node_idx = 0;
      vidx = 0;
      vertices = [];
...
},{"./math":4,"./light":17,"./shader_library":24,"./error":19}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./coffeegl":1,"./signal":16}],11:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var CoffeeGLDebug, CoffeeGLError, Fbo, RGB, RGBA, Vec2, _ref, _ref1;
...
},{"./error":19,"./colour":5,"./math":4}],12:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
- TODO 
  * Split out more - data can be an image or it could be something else?
    ...
    function Texture(url, params, callback) {
      ...
      r.get(function() {
        ...
        return _this.texImage.onload = function() {
          ...
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, _this.min);
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, _this.max);
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_S, _this.wraps);
          gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_WRAP_T, _this.wrapt);
          gl.bindTexture(gl.TEXTURE_2D, null);
          _this.loaded = true;
...
- TODO
  * Inverse Projection/Modelview Matrix add
  * Camera class. Added like a primtive but has no geometry 
  * Setup so that Z is out of the screen, with 0,0 being the centre. Right handed
  ...
  */
  ...
  Cylinder = (function(_super) {
    ...
    function Cylinder(radius, segments, height, colour) {
      var e, i, s, tangent, x, z, _i, _j, _k, _l, _m, _n, _o, _ref3;
      ...
      for (i = _i = 1; 1 <= segments ? _i <= segments : _i >= segments; i = 1 <= segments ? ++_i : --_i) {
        ...
        this.v.push(new Vertex(new Vec3(x, height, z), colour, Vec3.normalize(new Vec3(x, 1.0, z)), new Vec2(i / segments, 1.0), tangent));
      }
      this.v.push(new Vertex(new Vec3(0, -height, 0), colour, new Vec3(0, 0, -1.0), new Vec2(0.5, 1.0)));
      ...
      for (i = _o = 0, _ref3 = this.indices.length - 1; _o <= _ref3; i = _o += 3) {
        this.faces.push(new Triangle(this.v[this.indices[i]], this.v[this.indices[i + 1]], this.v[this.indices[i + 2]]));
      }
      this;
    }
...
(function() {
  var CoffeeGLWarning, CoffeeGLWarningOnce, Cuboid, Matrix4, Quad, RGB, RGBA, Sphere, Triangle, TriangleMesh, Vec2, Vec3, Vertex, WebGLNodeDrawable, brew, createArrayBuffer, createElementBuffer, deleteBuffer, drawGeometryGL, makeNodeDrawableGL, util, washup, _attribTypeCheckSet, _matchWithShader, _ref, _ref1, _ref2, _ref3, _ref4, _splitRole, _typeCheckSet;
  ...
  brew = function(geometry) {
    var colours, gl, normals, size, tangents, uvs, v, vertices, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _ref5, _ref6, _ref7, _ref8, _ref9;
    ...
    if (geometry.v[0].tangent != null) {
      if (geometry.vertexTangentBuffer == null) {
        ...
        geometry.vertexTangentBuffer = createArrayBuffer(new Float32Array(tangents), geometry.bufferType, 3);
      }
    }
...
},{"./math":4,"./colour":5,"./primitives":6,"./shapes":14,"./error":19,"./util":2}],17:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./colour":5}],16:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  */
  ...
  touchEmitter.touchDrag = new Signal();

  touchEmitter.ongoingTouches = [];

  makeTouchEmitter = function(obj) {
    var handleEnd, handleMove, handleStart,
      _this = this;
    if (obj.canvas != null) {
      ...
      handleStart = function(evt) {
        ...
        for (_i = 0, _len = touches.length; _i < _len; _i++) {
          ...
          _results.push(obj.ongoingTouches.push(touch));
        }
        return _results;
      };
      handleMove = function(evt) {
        var d0, d1, idx, touch, touches, _i, _len;
        evt.preventDefault();
        touches = evt.changedTouches;
        for (_i = 0, _len = touches.length; _i < _len; _i++) {
          touch = touches[_i];
          ...
          touch.cpos.x = touch.clientX;
          touch.cpos.y = touch.clientY;
        }
        if (touches.length === 2) {
          d0 = Vec2.dist(touches[0].cpos, touches[1].cpos);
          d1 = Vec2.dist(touches[0].ppos, touches[1].ppos);
          evt.ddist = d0 - d1;
          if (d0 > d1) {
      ...
      handleEnd = function(evt) {
        var i, touches, _i, _ref, _results;
        evt.preventDefault();
        touches = evt.changedTouches;
        _results = [];
        for (i = _i = 0, _ref = touches.length - 1; 0 <= _ref ? _i <= _ref : _i >= _ref; i = 0 <= _ref ? ++_i : --_i) {
          _results.push(ongoingTouches.splice(i, 1));
        }
        return _results;
      };
      obj.canvas.addEventListener("touchstart", handleStart, false);
      obj.canvas.addEventListener("touchend", handleEnd, false);
      obj.canvas.addEventListener("touchcancel", handleEnd, false);
      return obj.canvas.addEventListener("touchmove", handleMove, false);
    }
  };
...
},{"./util":2,"./math":4}],20:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./math":4}],21:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
  ...
  */
  ...
  Interpolation = (function() {
    ...
    function Interpolation(obj0, obj1) {
      ...
      if (this.obj0 instanceof Vec3) {
        this._set = this._setVec3;
      }
      if (this.obj0 instanceof Vec4) {
        this._set = this._setVec4;
      }
      if (this.obj0 instanceof RGB) {
        this._set = this._setRGB;
      }
      if (this.obj0 instanceof RGBA) {
    ...
    Interpolation.prototype._setVec2 = function() {
      return new Vec2(this.obj0.x + ((this.obj.x - this.obj0.x) * this.value), this.obj0.y + ((this.obj1.y - this.obj0.y) * this.value));
    };

    Interpolation.prototype._setVec3 = function() {
      return new Vec3(this.obj0.x + ((this.obj1.x - this.obj0.x) * this.value), this.obj0.y + ((this.obj1.y - this.obj0.y) * this.value), this.obj0.z + ((this.obj1.z - this.obj0.z) * this.value));
    };

    Interpolation.prototype._setVec4 = function() {
      return new Vec4(this.obj0.x + ((this.obj1.x - this.obj0.x) * this.value), this.obj0.y + ((this.obj1.y - this.obj0.y) * this.value), this.obj0.z + ((this.obj1.z - this.obj0.z) * this.value), this.obj0.w + ((this.obj1.w - this.obj0.w) * this.value));
    };

    Interpolation.prototype._setRGB = function() {
      return new RGB(this.obj0.r + ((this.obj1.r - this.obj0.r) * this.value), this.obj0.g + ((this.obj1.g - this.obj0.g) * this.value), this.obj0.b + ((this.obj1.b - this.obj0.b) * this.value));
    };

    Interpolation.prototype._setRGBA = function() {
      return new RGBA(this.obj0.r + ((this.obj1.r - this.obj0.r) * this.value), this.obj0.g + ((this.obj1.g - this.obj0.g) * this.value), this.obj0.b + ((this.obj1.b - this.obj0.b) * this.value), this.obj0.a + ((this.obj1.a - this.obj0.a) * this.value));
    };
...
},{"./math":4,"./colour":5,"./error":19}],22:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
(function() {
