...
},{"./util":2,"./app":3,"./math":4,"./colour":5,"./primitives":6,"./node":7,"./model":8,"./shader":9,"./request":10,"./texture":11,"./camera":12,"./shapes":13,"./webgl":14,"./control":15,"./light":16,"./material":17,"./error":18}],2:[function(require,module,exports){
...
(function() {
  ...
  makeMouseEmitter = require("./control").makeMouseEmitter;

  Colour = require("./colour").Colour;

  App = (function() {

    function App(element, init, draw, update, onError, debug) {
      var _this = this;
      this.init = init;
      this.draw = draw;
      this.update = update;
      ...
      this.resize = function() {
        return App.prototype.resize.apply(_this, arguments);
      };
      ...
      this.lights = [];
      this.material;
      this.ambient = new Colour.RGB(0.01, 0.01, 0.01);
      this.mv = new Matrix4();
      if (this.debug) {
...
},{"./math":4,"./shader":9,"./control":15,"./colour":5,"./camera":12}],4:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  Quaternion = (function() {
    ...
    Quaternion.prototype.transVec = function(v) {
      var cm, pm, vm;
      vm = 2 * (this.v.x * v.x + this.v.y * v.y + this.v.z * v.z);
      cm = 2 * this.w;
      pm = cm * this.w - 1.0;
      return new Vec3(pm * v.x + vm * this.v.x + cm * (this.v.y * v.z - this.v.z * v.y), pm * v.y + vm * this.v.y + cm * (this.v.z * v.x - this.v.x * v.z), pm * v.z + vm * this.v.z + cm * (this.v.x * v.y - this.v.y * v.x));
    };
...
},{"./error":18}],6:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
    ...
    Node.prototype._draw = function(node, m) {
      ...
      if (node.pointLights != null) {
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          ...
          newlight.pos = node._modelMatrix.multVec3(newlight.pos);
...
},{"./math":4,"./webgl":14,"./camera":12,"./material":17,"./texture":11,"./Light":19,"./primitives":6,"./util":2}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./primitives":6,"./node":7,"./math":4,"./material":17,"./colour":5,"./texture":11,"./request":10,"./error":18}],9:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  Shader = (function() {
    ...
    Shader.prototype.washUp = function() {
      ...
      return gl.detachShader(this.shaderProgram, this.fragmentShader);
    };

    Shader.prototype._makeContract = function(roles) {
      var role;
...
},{"./math":4,"./light":16,"./shader_library":20,"./error":18}],10:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  makeMouseListener = require('./control').makeMouseListener;
  ...
  MousePerspCamera = (function(_super) {
    ...
    MousePerspCamera.prototype.onMouseMove = function(event) {
      var dir, x, y, _ref1;
      _ref1 = this.getMousePos(event), x = _ref1[0], y = _ref1[1];
      this.dx = x - this.px;
      this.px = x;
      this.q.fromAxisAngle(this.up, degToRad(this.dx * this.sense));
      this.m.mult(this.q.getMatrix4());
      this.pos = this.q.transVec(this.pos);
      this.up = this.q.transVec(this.up);
      this.dy = y - this.py;
      this.py = y;
      dir = Vec3.sub(this.look, this.pos);
      dir.normalize();
      this.q.fromAxisAngle(Vec3.cross(this.up, dir), degToRad(this.dy * this.sense));
      this.m.mult(this.q.getMatrix4());
      return this;
    };
    ...
    MousePerspCamera.prototype.onMouseOver = function(event) {
      ...
      if (this.px === 0 && this.py === 0) {
        return _ref1 = this.getMousePos(event), this.px = _ref1[0], this.py = _ref1[1], _ref1;
      }
    };
...
},{"./math":4,"./primitives":6,"./control":15}],13:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./coffeegl":1,"./node":7,"./colour":5,"./math":4,"./primitives":6}],14:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var CoffeeGLWarning, CoffeeGLWarningOnce, Colour, Matrix4, Quad, Triangle, TriangleMesh, Vec2, Vec3, Vertex, WebGLQuad, WebGLTriangle, WebGLTriangleMesh, createArrayBuffer, createElementBuffer, deleteBuffer, makeDrawableGL, util, _drawGL, _matchWithShader, _ref, _ref1, _ref2, _splitRole, _typeCheckSet, _washup;
  ...
  _typeCheckSet = function(u, v, tag) {
    ...
    if (u.size === 1) {
      if (u.type === "float") {
        return gl.uniform1f(u.pos, v[role]);
      } else if (u.type === "int") {
        return gl.uniform1i(u.pos, v[role]);
      } else if (u.type === "vec2") {
        return gl.uniform2f(u.pos, v[role].x, v[role].y);
      } else if (u.type === "vec3") {
        if (v[role].x != null) {
          return gl.uniform3f(u.pos, v[role].x, v[role].y, v[role].z);
        } else {
          return gl.uniform3f(u.pos, v[role].r, v[role].g, v[role].b);
        }
      } else if (u.type === "vec4") {
        if (v[role].x != null) {
          return gl.uniform4f(u.pos, v[role].x, v[role].y, v[role].z, v[role].w);
        } else {
          return gl.uniform3f(u.pos, v[role].r, v[role].g, v[role].b, v[role].a);
        }
      } else if (u.type === "mat4") {
        return gl.uniformMatrix4fv(u.pos, false, v[role].a);
      } else if (u.type === "mat3") {
        return gl.uniformMatrix3fv(u.pos, false, v[role].a);
      } else if (u.type === "sampler2D") {
        return gl.uniform1u(u.pos, v[role]);
      }
    } else {
      if (u.type === "float") {
        return gl.uniform1fv(u.pos, new Float32Array(v[role]));
      } else if (u.type === "int") {
        return gl.uniform1iv(u.pos, new Int32Array(v[role]));
      } else if (u.type === "vec2") {
        return gl.uniform2fv(u.pos, new Float32Array(v[role]));
      } else if (u.type === "vec3") {
        return gl.uniform3fv(u.pos, new Float32Array(v[role]));
      } else if (u.type === "vec4") {
        return gl.uniform4fv(u.pos, new Float32Array(v[role]));
      }
    }
  };
  ...
  _matchWithShader = function(obj) {
    var attenuations, colours, contract, light, pointlights, positions, shader, speculars, t, u, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _len6, _m, _n, _o, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
  ...
  _drawGL = function(obj, drawPrimitive) {
    var aVertexColour, aVertexNormal, aVertexPosition, aVertexTangent, aVertexTexCoord, context, gl, shader;
    ...
    if (shader == null) {
      CoffeeGLWarning("No Shader bound but WebGL Draw called");
      return obj;
    }
    _matchWithShader(obj);
    if (obj.vertexPositionBuffer != null) {
      aVertexPosition = shader._posForAttrRole("aVertexPosition");
      if (aVertexPosition !== -1) {
        gl.enableVertexAttribArray(aVertexPosition);
        gl.bindBuffer(gl.ARRAY_BUFFER, obj.vertexPositionBuffer);
        gl.vertexAttribPointer(aVertexPosition, obj.vertexPositionBuffer.itemSize, gl.FLOAT, false, 0, 0);
      }
    }
    if (obj.vertexTextureBuffer != null) {
      aVertexTexCoord = shader._posForAttrRole("aVertexTexCoord");
      if (aVertexTexCoord !== -1) {
        gl.enableVertexAttribArray(aVertexTexCoord);
        gl.bindBuffer(gl.ARRAY_BUFFER, obj.vertexTextureBuffer);
        gl.vertexAttribPointer(aVertexTexCoord, obj.vertexTextureBuffer.itemSize, gl.FLOAT, false, 0, 0);
      }
    }
    if (obj.vertexNormalBuffer != null) {
      aVertexNormal = shader._posForAttrRole("aVertexNormal");
      if (aVertexNormal !== -1) {
        gl.enableVertexAttribArray(aVertexNormal);
        gl.bindBuffer(gl.ARRAY_BUFFER, obj.vertexNormalBuffer);
        gl.vertexAttribPointer(aVertexNormal, obj.vertexNormalBuffer.itemSize, gl.FLOAT, false, 0, 0);
      }
    }
    if (obj.vertexColourBuffer != null) {
      aVertexColour = shader._posForAttrRole("aVertexColour");
      if (aVertexColour !== -1) {
        gl.enableVertexAttribArray(aVertexColour);
        gl.bindBuffer(gl.ARRAY_BUFFER, obj.vertexColourBuffer);
        gl.vertexAttribPointer(aVertexColour, obj.vertexColourBuffer.itemSize, gl.FLOAT, false, 0, 0);
      }
    }
    if (obj.vertexTangentBuffer != null) {
      aVertexTangent = shader._posForAttrRole("aVertexTangent");
      if (aVertexTangent !== -1) {
        gl.enableVertexAttribArray(aVertexTangent);
        gl.bindBuffer(gl.ARRAY_BUFFER, obj.vertexTangentBuffer);
        gl.vertexAttribPointer(aVertexTangent, obj.vertexTangentBuffer.itemSize, gl.FLOAT, false, 0, 0);
      }
    }
...
},{"./math":4,"./colour":5,"./primitives":6,"./error":18,"./util":2}],15:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  var makeMouseEmitter, makeMouseListener, mouseEmitter, mouseListener, util;

  util = require("./util");

  mouseEmitter = {};

  mouseEmitter["_mouseListeners"] = [];
  ...
  makeMouseEmitter = function(obj) {
    if (obj.canvas != null) {
      ...
      obj.canvas.onmousemove = function(event) {
        ...
        _ref = obj._mouseListeners;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseMove === "function" ? l.onMouseMove(event) : void 0);
        }
        return _results;
      };
      obj.canvas.onmousedown = function(event) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseDown === "function" ? l.onMouseDown(event) : void 0);
        }
        return _results;
      };
      obj.canvas.onmouseup = function(event) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseUp === "function" ? l.onMouseUp(event) : void 0);
        }
        return _results;
      };
      obj.canvas.onmouseclick = function(event) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseClick === "function" ? l.onMouseClick(event) : void 0);
        }
        return _results;
      };
      obj.canvas.onmouseout = function(event) {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseOut === "function" ? l.onMouseOut(event) : void 0);
        }
        return _results;
      };
      return obj.canvas.onmouseover = function(event) {
        var l, _i, _len, _ref, _results;
        _ref = obj._mouseListeners;
        _results = [];
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          l = _ref[_i];
          _results.push(typeof l.onMouseOver === "function" ? l.onMouseOver(event) : void 0);
        }
        return _results;
      };
    }
  ...
  mouseListener["getMousePos"] = function(e) {
    var posx, posy;
    posx = 0;
    posy = 0;
    if (e.pageX || e.pageY) {
  ...
  makeMouseListener = function(obj) {
    if ((obj != null) && (CoffeeGL.Context != null)) {
      if (CoffeeGL.Context._mouseListeners != null) {
        util.extend(obj, mouseListener);
        return CoffeeGL.Context._mouseListeners.push(obj);
      }
    }
  };
  ...
  module.exports = {
    ...
    makeMouseListener: makeMouseListener
  };

}).call(this);

},{"./util":2}],16:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./math":4,"./colour":5}],17:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  ShaderLibrary = (function() {
    ...
    ShaderLibrary.BasicTextureShader = {
      vertex: "attribute vec2 aVertexTexCoord;varying vec2 vTexCoord;varying vec4 vTransformedNormal;void main(void) {gl_Position = uProjectionMatrix * uCameraMatrix * uModeMatrix * vec4(aVertexPosition, 1.0);vColor = aVertexColour;vTexCoord = aVertexTexCoord;vTransformedNormal =  uNormalMatrix * vec4(aVertexNormal, 1.0); }",
      fragment: "varying vec2 vTexCoord;uniform sampler2D uSampler;void main() {   gl_FragColor = texture2D(uSampler,vTexCoord);}"
    };
