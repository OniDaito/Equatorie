...
},{"./util":2,"./app":3,"./math":4,"./colour":5,"./primitives":6,"./node":7,"./model":8,"./shader":9,"./request":10,"./fbo":11,"./texture":12,"./camera":13,"./webgl":14,"./shapes":15,"./signal":16,"./light":17,"./material":18,"./error":19}],2:[function(require,module,exports){
...
(function() {
  ...
  rayPlaneIntersect = function(plane_point, plane_normal, line_point, line_dir) {
    var den, num;
    num = Vec3.sub(plane_point, line_point).dot(plane_normal);
    den = Vec3.dot(line_dir, plane_normal);
    return num / den;
  };
    ...
    Node.prototype._draw = function(node, front) {
      ...
      if (node.pointLights != null) {
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          ...
          front._modelMatrix.multVec3(newlight.pos);
...
},{"./math":4,"./webgl":14,"./camera":13,"./material":18,"./texture":12,"./Light":20,"./primitives":6,"./util":2}],8:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
(function() {
  ...
  PerspCamera = (function(_super) {
    ...
    PerspCamera.prototype.castRay = function(sx, sy) {
      ...
      if (CoffeeGL.Context != null) {
        gl = CoffeeGL.Context.gl;
        g = new Vec3(sx / CoffeeGL.Context.width * 2 - 1, sy / CoffeeGL.Context.height * 2 - 1, 0);
        pp = Matrix4.invert(this.p);
        mp = Matrix4.invert(this.m);
        mp.multVec3(g);
        pp.multVec3(g);
        return g.normalize();
      }
...
(function() {
  ...
  /*
  WebGLNodeDrawable.endDrawGL = () -> 
    if @._shader?
      @._shader.unbind()
      #CoffeeGL.Context.shader = @saved_shader
    @
  */
...
},{"./math":4,"./colour":5,"./primitives":6,"./shapes":15,"./error":19,"./util":2}],15:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
...
},{"./coffeegl":1,"./node":7,"./colour":5,"./math":4,"./primitives":6}],16:[function(require,module,exports){
// Generated by CoffeeScript 1.6.1
